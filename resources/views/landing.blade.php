<x-guest-layout>
    ...
    <!------>
    <div class="pt-24">
        <div class="container flex flex-col items-center px-12 mx-auto lg:flex-row-reverse">
            <!--Right Col-->
            <div class="hidden w-full py-6 text-center lg:flex md:w-3/5">
                <img class="w-full m-auto md:w-4/5" src="img/hero.png" />
            </div>
            <!--Left Col-->
            <div class="flex flex-col items-start justify-center w-full pt-24 space-y-10 text-center lg:w-2/5 md:text-left">
                <p class="w-full text-center text-white uppercase lg:text-left tracking-loose">E-commerce, Messaging, Socialmedia Networking, B2B & B2C</p>
                <div class="hidden w-full py-6 text-center md:flex lg:hidden">
                    <img class="w-1/2 m-auto" src="img/hero.png" />
                </div>
                <h1 class="text-4xl font-bold leading-tight text-center text-white lg:text-left">
                    Dedicated team for building your mobile and web applications
                </h1>
                <div class="w-full text-center md:hidden">
                    <img class="w-2/3 m-auto" src="img/hero.png" />
                </div>
                <p class="text-xl leading-relaxed text-center text-white lg:text-left">
...
86127-3.44684,13,1c3.89856,1.55639,5.72674,1.19856,5.98014,4.5852a64.6209,64.6209,0,0,0,13.39649,35.03447l.08459.10943,5.56937-5.0821,7.16061,5.71736,30.23374.63526s4.77379-23.50471-11.13873-50.18576-48.53312-12.07-48.53312-12.07C715.01986,274.7492,721.54425,293.73482,721.54425,293.73482Z" transform="translate(-182.27071 -127.26518)" fill="#ff6347" />
    ...
    <section id="tech" class="py-8 bg-white border-b">
        <div class="container flex flex-col flex-wrap pt-4 pb-10 mx-auto space-y-12">
            ...
            <a href="{{ route('our-tech') }}" class="px-8 py-3 mx-auto font-extrabold duration-300 ease-in-out transform rounded shadow hover:scale-110 button opacity-80 hover:underline">
                Explore More
            </a>
        </div>
    </section>
