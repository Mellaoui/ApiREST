<div>
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="other-filters" id="other-filters" class="w-full border-none rounded-xl px-4 py-2">
        ...
        <div class="w-full md:w-1/3 relative">
            <input wire:model="search" type="search" placeholder="Find and Idea" class="w-full rounded bg-white px-4 py-2 pl-8 placeholder-gray-900 border-none">
