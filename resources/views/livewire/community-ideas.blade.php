<div>
    <div class="flex flex-col space-y-3 filters md:flex-row md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="other-filters" id="other-filters" class="w-full px-4 py-2 border-none rounded-xl">
                <option value="other-filters One"> No Filter</option>
        ...
        <div class="relative w-full md:w-1/3">
            <input wire:model="search" type="search" placeholder="Find and Idea" class="w-full px-4 py-2 pl-8 placeholder-gray-900 bg-white border-none rounded">
