...
<div 
    ...
    class="fixed z-10 inset-0 overflow-y-auto pb-0" 
    ...
    <div class="flex items-end justify-center min-h-screen">
        <!--
            ...
            To: "opacity-0"
        -->
        <div x-show.transition.opacity="isOpen" class="fixed inset-0 bg-gray-300 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
