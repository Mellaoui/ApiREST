            ...
            <div class="flex flex-wrap -m-4">
                    ...
                    <div class="overflow-hidden transition duration-75 border-gray-200 rounded hover:shadow-xl">
                        ...
                        <div class="px-6 py-4">
                            ...
                            <p class="text-base text-gray-400">
                                A place where Doctors can track thier patients from anywhere.
                            </p>
                        </div>
                ...
                <div class="p-4 xl:w-1/3 md:w-1/2">
                    <div class="p-6 border border-gray-200 rounded-lg">
                        ...
                        <h2 class="mb-2 text-lg font-medium text-gray-200 title-font">Comming Soon </h2>
                        <p class="text-base leading-relaxed text-gray-400">......</p>
                    </div>
                </div>
                <div class="p-4 xl:w-1/3 md:w-1/2">
                    <div class="p-6 border border-gray-200 rounded-lg">
